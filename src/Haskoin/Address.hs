...
addrToText net a@PubKeyAddress{getAddrHash160 = h} = Just . encodeBase58Check . runPutS $ base58put net a
addrToText net a@ScriptAddress{getAddrHash160 = h} = Just . encodeBase58Check . runPutS $ base58put net a
